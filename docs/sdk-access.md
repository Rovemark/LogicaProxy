...
The `github.com/Rovemark/LogicaProxy/v6/sdk/access` package centralizes inbound request authentication for the proxy. It offers a lightweight manager that chains credential providers, so servers can reuse the same access control logic inside or outside the CLI runtime.
...
Add the module with `go get github.com/Rovemark/LogicaProxy/v6/sdk/access`.
...
```go
// configaccess is github.com/Rovemark/LogicaProxy/v6/internal/access/config_access
