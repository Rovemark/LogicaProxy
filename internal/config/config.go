// Package config provides configuration management for the LogicaProxy server.
...
const (
	DefaultPanelGitHubRepository = "https://github.com/Rovemark/Cli-Proxy-API-Management-Center"
