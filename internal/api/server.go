// Package api provides the HTTP API server implementation for the LogicaProxy.
...
import (
	...
	"github.com/Rovemark/LogicaProxy/v6/internal/access"
	managementHandlers "github.com/Rovemark/LogicaProxy/v6/internal/api/handlers/management"
	"github.com/Rovemark/LogicaProxy/v6/internal/api/middleware"
	"github.com/Rovemark/LogicaProxy/v6/internal/api/modules"
	ampmodule "github.com/Rovemark/LogicaProxy/v6/internal/api/modules/amp"
	"github.com/Rovemark/LogicaProxy/v6/internal/config"
	"github.com/Rovemark/LogicaProxy/v6/internal/dashboard"
	"github.com/Rovemark/LogicaProxy/v6/internal/logging"
	"github.com/Rovemark/LogicaProxy/v6/internal/managementasset"
	"github.com/Rovemark/LogicaProxy/v6/internal/usage"
	"github.com/Rovemark/LogicaProxy/v6/internal/util"
	sdkaccess "github.com/Rovemark/LogicaProxy/v6/sdk/access"
	"github.com/Rovemark/LogicaProxy/v6/sdk/api/handlers"
	"github.com/Rovemark/LogicaProxy/v6/sdk/api/handlers/claude"
	"github.com/Rovemark/LogicaProxy/v6/sdk/api/handlers/gemini"
	"github.com/Rovemark/LogicaProxy/v6/sdk/api/handlers/openai"
	sdkAuth "github.com/Rovemark/LogicaProxy/v6/sdk/auth"
	"github.com/Rovemark/LogicaProxy/v6/sdk/cliproxy/auth"
...
type Server struct {
	...
	// metrics tracks request metrics for the /metrics endpoint.
...
func (s *Server) setupRoutes() {
	...
	// Dashboard UI
	dashboard.RegisterRoutes(s.engine)
